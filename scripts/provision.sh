...
GITHUB_ACCOUNT=${GITHUB_ACCOUNT:-justone0127}
...
function deploy() {
  ...
  local template=https://raw.githubusercontent.com/$GITHUB_ACCOUNT/openshift-jenkins/$GITHUB_REF/cicd-template.yaml
